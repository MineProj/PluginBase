...
public class FileUtils {
     ...
     * @throws IOException If an I/O error occurs.
     * @see org.apache.commons.io.file.PathUtils#fileContentEquals(Path,Path)
     */
    public static boolean contentEquals(final File file1, final File file2) throws IOException {
        ...
        return org.apache.commons.io.file.PathUtils.fileContentEquals(file1.toPath(), file2.toPath());
    }
    ...
    public static void copyURLToFile(final URL source, final File destination) throws IOException {
        ...
        org.apache.commons.io.file.PathUtils.createParentDirectories(path);
        org.apache.commons.io.file.PathUtils.copy(source::openStream, path, StandardCopyOption.REPLACE_EXISTING);
    }
    ...
    public static File current() {
        return org.apache.commons.io.file.PathUtils.current().toFile();
    }
    ...
    public static void forceDelete(final File file) throws IOException {
        Objects.requireNonNull(file, "file");
        final org.apache.commons.io.file.Counters.PathCounters deleteCounters;
        try {
            deleteCounters = org.apache.commons.io.file.PathUtils.delete(file.toPath(), org.apache.commons.io.file.PathUtils.EMPTY_LINK_OPTION_ARRAY,
                org.apache.commons.io.file.StandardDeleteOption.OVERRIDE_READ_ONLY);
    ...
    public static boolean isEmptyDirectory(final File directory) throws IOException {
        return org.apache.commons.io.file.PathUtils.isEmptyDirectory(directory.toPath());
    }
    ...
    public static boolean isFileNewer(final File file, final ChronoZonedDateTime<?> chronoZonedDateTime) {
        ...
        return Uncheck.get(() -> org.apache.commons.io.file.PathUtils.isNewer(file.toPath(), chronoZonedDateTime));
    }
    ...
    public static boolean isFileNewer(final File file, final File reference) {
        ...
        return Uncheck.get(() -> org.apache.commons.io.file.PathUtils.isNewer(file.toPath(), reference.toPath()));
    }
    ...
    public static boolean isFileNewer(final File file, final FileTime fileTime) throws IOException {
        Objects.requireNonNull(file, "file");
        return org.apache.commons.io.file.PathUtils.isNewer(file.toPath(), fileTime);
    }
    ...
    public static boolean isFileNewer(final File file, final Instant instant) {
        ...
        return Uncheck.get(() -> org.apache.commons.io.file.PathUtils.isNewer(file.toPath(), instant));
    }
    ...
    public static boolean isFileNewer(final File file, final long timeMillis) {
        Objects.requireNonNull(file, "file");
        return Uncheck.get(() -> org.apache.commons.io.file.PathUtils.isNewer(file.toPath(), timeMillis));
    }
    ...
    public static boolean isFileOlder(final File file, final File reference) {
        requireExists(reference, "reference");
        return Uncheck.get(() -> org.apache.commons.io.file.PathUtils.isOlder(file.toPath(), reference.toPath()));
    }
    ...
    public static boolean isFileOlder(final File file, final FileTime fileTime) throws IOException {
        Objects.requireNonNull(file, "file");
        return org.apache.commons.io.file.PathUtils.isOlder(file.toPath(), fileTime);
    }
    ...
    public static boolean isFileOlder(final File file, final Instant instant) {
        Objects.requireNonNull(instant, "instant");
        return Uncheck.get(() -> org.apache.commons.io.file.PathUtils.isOlder(file.toPath(), instant));
    }
    ...
    public static boolean isFileOlder(final File file, final long timeMillis) {
        Objects.requireNonNull(file, "file");
        return Uncheck.get(() -> org.apache.commons.io.file.PathUtils.isOlder(file.toPath(), timeMillis));
    }
    ...
    private static org.apache.commons.io.file.AccumulatorPathVisitor listAccumulate(final File directory, final IOFileFilter fileFilter, final IOFileFilter dirFilter,
                                                                                    final FileVisitOption... options) throws IOException {
        final boolean isDirFilterSet = dirFilter != null;
        final org.apache.commons.io.filefilter.FileEqualsFileFilter rootDirFilter = new org.apache.commons.io.filefilter.FileEqualsFileFilter(directory);
        final PathFilter dirPathFilter = isDirFilterSet ? rootDirFilter.or(dirFilter) : rootDirFilter;
        final org.apache.commons.io.file.AccumulatorPathVisitor visitor = new org.apache.commons.io.file.AccumulatorPathVisitor(org.apache.commons.io.file.Counters.noopPathCounters(), fileFilter, dirPathFilter,
     ...
     *                   use {@link org.apache.commons.io.filefilter.TrueFileFilter#INSTANCE} to match all files in selected directories.
     * @param dirFilter  optional filter to apply when finding subdirectories.
     *                   If this parameter is {@code null}, subdirectories will not be included in the
     *                   search. Use {@link org.apache.commons.io.filefilter.TrueFileFilter#INSTANCE} to match all directories.
    ...
    public static Collection<File> listFiles(final File directory, final IOFileFilter fileFilter, final IOFileFilter dirFilter) {
        final org.apache.commons.io.file.AccumulatorPathVisitor visitor = Uncheck
            .apply(d -> listAccumulate(d, org.apache.commons.io.filefilter.FileFileFilter.INSTANCE.and(fileFilter), dirFilter, FileVisitOption.FOLLOW_LINKS), directory);
    ...
    public static Collection<File> listFilesAndDirs(final File directory, final IOFileFilter fileFilter, final IOFileFilter dirFilter) {
        final org.apache.commons.io.file.AccumulatorPathVisitor visitor = Uncheck.apply(d -> listAccumulate(d, fileFilter, dirFilter, FileVisitOption.FOLLOW_LINKS),
            directory);
     ...
     * @throws IOException if an I/O error occurs.
     * @see org.apache.commons.io.file.PathUtils#newOutputStream(Path, boolean)
     * @since 2.12.0
     */
    public static OutputStream newOutputStream(final File file, final boolean append) throws IOException {
        return org.apache.commons.io.file.PathUtils.newOutputStream(Objects.requireNonNull(file, "file").toPath(), append);
    }
    ...
    public static long sizeOf(final File file) {
        ...
        return Uncheck.get(() -> org.apache.commons.io.file.PathUtils.sizeOf(file.toPath()));
    }
    ...
    public static BigInteger sizeOfAsBigInteger(final File file) {
        requireExists(file, "file");
        return Uncheck.get(() -> org.apache.commons.io.file.PathUtils.sizeOfAsBigInteger(file.toPath()));
    }
    ...
    public static long sizeOfDirectory(final File directory) {
        requireDirectoryExists(directory, "directory");
        return Uncheck.get(() -> org.apache.commons.io.file.PathUtils.sizeOfDirectory(directory.toPath()));
    }
    ...
    public static BigInteger sizeOfDirectoryAsBigInteger(final File directory) {
        requireDirectoryExists(directory, "directory");
        return Uncheck.get(() -> org.apache.commons.io.file.PathUtils.sizeOfDirectoryAsBigInteger(directory.toPath()));
    }
    ...
    public static Stream<File> streamFiles(final File directory, final boolean recursive, final String... extensions) throws IOException {
        ...
        final IOFileFilter filter = extensions == null
            ? org.apache.commons.io.filefilter.FileFileFilter.INSTANCE
            : org.apache.commons.io.filefilter.FileFileFilter.INSTANCE.and(new org.apache.commons.io.filefilter.SuffixFileFilter(toSuffixes(extensions)));
        // @formatter:on
        return org.apache.commons.io.file.PathUtils.walk(directory.toPath(), filter, toMaxDepth(recursive), false, FileVisitOption.FOLLOW_LINKS).map(Path::toFile);
    }
    ...
    public static void touch(final File file) throws IOException {
        org.apache.commons.io.file.PathUtils.touch(Objects.requireNonNull(file, "file").toPath());
    }
    ...
    public static boolean waitFor(final File file, final int seconds) {
        Objects.requireNonNull(file, "file");
        return org.apache.commons.io.file.PathUtils.waitFor(file.toPath(), Duration.ofSeconds(seconds), org.apache.commons.io.file.PathUtils.EMPTY_LINK_OPTION_ARRAY);
    }
