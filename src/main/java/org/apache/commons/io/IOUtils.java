...
public class IOUtils {
    ...
    public static long consume(final InputStream input) throws IOException {
        return copyLarge(input, org.apache.commons.io.output.NullOutputStream.INSTANCE);
    }
    ...
    public static long consume(final Reader input) throws IOException {
        return copyLarge(input, org.apache.commons.io.output.NullWriter.INSTANCE);
    }
    ...
    public static byte[] toByteArray(final InputStream inputStream) throws IOException {
        ...
        try (org.apache.commons.io.output.UnsynchronizedByteArrayOutputStream ubaOutput = org.apache.commons.io.output.UnsynchronizedByteArrayOutputStream.builder().get();
             org.apache.commons.io.output.ThresholdingOutputStream thresholdOutput = new org.apache.commons.io.output.ThresholdingOutputStream(Integer.MAX_VALUE, os -> {
    ...
    public static String toString(final InputStream input, final Charset charset) throws IOException {
        try (org.apache.commons.io.output.StringBuilderWriter sw = new org.apache.commons.io.output.StringBuilderWriter()) {
    ...
    public static Writer writer(final Appendable appendable) {
        ...
        if (appendable instanceof StringBuilder) {
            return new org.apache.commons.io.output.StringBuilderWriter((StringBuilder) appendable);
        }
        return new org.apache.commons.io.output.AppendableWriter<>(appendable);
    }
