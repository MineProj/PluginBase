...
public class ReaderInputStream extends InputStream {
     ...
     * {@value org.apache.commons.io.IOUtils#DEFAULT_BUFFER_SIZE} characters.
     *
    ...
    /**
     * Constructs a new {@link ReaderInputStream} with a default input buffer size of {@value org.apache.commons.io.IOUtils#DEFAULT_BUFFER_SIZE} characters.
     *
     * <p>
    ...
    public ReaderInputStream(final Reader reader, final Charset charset) {
        this(reader, charset, org.apache.commons.io.IOUtils.DEFAULT_BUFFER_SIZE);
    }
    ...
    public ReaderInputStream(final Reader reader, final CharsetEncoder charsetEncoder) {
        this(reader, charsetEncoder, org.apache.commons.io.IOUtils.DEFAULT_BUFFER_SIZE);
    }
    ...
    public ReaderInputStream(final Reader reader, final String charsetName) {
        this(reader, charsetName, org.apache.commons.io.IOUtils.DEFAULT_BUFFER_SIZE);
    }
