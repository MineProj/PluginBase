...
public class ReflectionDiffBuilder<T> implements Builder<DiffResult<T>> {
    ...
    private void appendFields(final Class<?> clazz) {
        for (final Field field : org.apache.commons.lang3.reflect.FieldUtils.getAllFields(clazz)) {
            if (accept(field)) {
                try {
                    diffBuilder.append(field.getName(), org.apache.commons.lang3.reflect.FieldUtils.readField(field, left, true),
                            org.apache.commons.lang3.reflect.FieldUtils.readField(field, right, true));
