...
public class MethodUtils {
    ...
    static Object[] getVarArgs(final Object[] args, final Class<?>[] methodParameterTypes) {
        ...
        Object varArgsArray = Array.newInstance(org.apache.commons.lang3.ClassUtils.primitiveToWrapper(varArgComponentType), varArgLength);
    ...
    public static Method getMatchingAccessibleMethod(final Class<?> cls,
        ...
        if (bestMatch != null && bestMatch.isVarArgs() && bestMatch.getParameterTypes().length > 0 && parameterTypes.length > 0) {
            ...
            final String methodParameterComponentTypeName = org.apache.commons.lang3.ClassUtils.primitiveToWrapper(methodParameterComponentType).getName();
    ...
    public static Method getMatchingMethod(final Class<?> cls, final String methodName,
        ...
        org.apache.commons.lang3.ClassUtils.getAllSuperclasses(cls).stream()
        ...
        methods.stream()
                .filter(method -> org.apache.commons.lang3.ClassUtils.isAssignable(parameterTypes, method.getParameterTypes(), true))
                .forEach(method -> {
    ...
    private static int distance(final Class<?>[] fromClassArray, final Class<?>[] toClassArray) {
        ...
        if (!org.apache.commons.lang3.ClassUtils.isAssignable(fromClassArray, toClassArray, true)) {
            return -1;
        }
        for (int offset = 0; offset < fromClassArray.length; offset++) {
            ...
            if (aClass == null || aClass.equals(toClass)) {
                continue;
            } else if (org.apache.commons.lang3.ClassUtils.isAssignable(aClass, toClass, true)
                    && !org.apache.commons.lang3.ClassUtils.isAssignable(aClass, toClass, false)) {
                answer++;
            } else {
                answer = answer + 2;
            }
     ...
     * @since 3.2
     */
    public static Set<Method> getOverrideHierarchy(final Method method, final org.apache.commons.lang3.ClassUtils.Interfaces interfacesBehavior) {
        ...
        final Iterator<Class<?>> hierarchy = org.apache.commons.lang3.ClassUtils.hierarchy(declaringClass, interfacesBehavior).iterator();
    ...
    /**
     * <p>Gets a combination of {@link org.apache.commons.lang3.ClassUtils#getAllSuperclasses(Class)} and
     * {@link org.apache.commons.lang3.ClassUtils#getAllInterfaces(Class)}, one from superclasses, one
